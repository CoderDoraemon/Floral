...
extension LDRecommendController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if indexPath.section == 0 && urls.count > 0 {
            ...
            headerView.setData(title: group.title, total: group.total, isMore: group.more, urls: urls)
            ...
            headerView.setData(title: group.title, total: group.total, isMore: group.more)
